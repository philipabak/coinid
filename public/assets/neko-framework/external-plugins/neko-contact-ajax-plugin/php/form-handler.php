...
if(isset($_POST["verify"])){
    ...
    } else if(($_SESSION['security_code'] == $verify) && (!empty($_SESSION['security_code'])) ) { 
...
//        $contact = submitContactForm($_POST['contact_name'], $_POST['contact_subject'], $_POST['contact_email'], $_POST['contact_message']);
        // if ($contact['result']) {
        //     $dosuccess = "Your message has been submitted, we will get back to you soon";
        //     unset($_POST['name']);
        //     unset($_POST['email']);
        //     unset($_POST['phone']);
        //     unset($_POST['comment']);
